...
import com.tgy.clouddisk.dao.req.UploadReq;
import com.tgy.clouddisk.entity.OriginFile;
import com.tgy.clouddisk.entity.UserFile;
import com.tgy.clouddisk.service.DownloadService;
import com.tgy.clouddisk.service.UploadService;
import com.tgy.clouddisk.service.UserService;
import com.tgy.clouddisk.util.validation.ParamChecker;
...
//    private ModelMapper modelMapper;
    ...
    public Map<String, Object> upload(HttpServletRequest req, @RequestPart("files[]") Part part, @Valid UploadReq reqbody) throws IOException {
        // TODO 参数校验
        ...
        if (isFirstPart(contentRange)) {
            ...
            UserFile localFile =new UserFile();
