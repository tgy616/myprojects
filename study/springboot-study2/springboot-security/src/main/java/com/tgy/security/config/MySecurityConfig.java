package com.tgy.security.config;
...
public class MySecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.inMemoryAuthentication().withUser("tgy").password("123456").roles("VIP1","VIP2")
                .and()
                .withUser("cc").password("1234").roles("VIP2","VIP3")
                .and()
                .withUser("admin").password("1234").roles("VIP1","VIP2","VIP3");
